...
// axios.get("languages.json").then(function(response) {
//     serviceText = response.data
//     axios.get("services.json").then(function(response){
//         servicesTable = response.data;
//         populateCheckboxes();
//     })
// });

axios.all("languages.json", "services.json").then(function(response1, response2){
    serviceText = response1.data;
    servicesTable = response2.data;
});
